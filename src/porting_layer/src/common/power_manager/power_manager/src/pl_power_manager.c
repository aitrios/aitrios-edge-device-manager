...
#include "pl_power_manager_os_impl.h"
...
PlErrCode PlPowerMgrInitialize(void) {
  ...
  err_code = PlPowerMgrInitializeOsImpl();
...
PlErrCode PlPowerMgrFinalize(void) {
  ...
  err_code = PlPowerMgrFinalizeOsImpl();
  if (err_code != kPlErrCodeOk) {
...
PlErrCode PlPowerMgrGetSupplyType(PlPowerMgrSupplyType *type) {
  ...
  err_code = PlPowerMgrGetSupplyTypeOsImpl(type);
  if (err_code != kPlErrCodeOk) {
...
PlErrCode PlPowerMgrSetupUsb(void) {
  ...
  err_code = PlPowerMgrSetupUsbOsImpl();
  if (err_code != kPlErrCodeOk) {
...
PlErrCode PlPowerMgrGetMigrationData(PlPowerMgrMigrationDataId id,
  ...
  pl_ret = PlPowerMgrGetMigrationDataOsImpl(id, dst, dst_size);
...
PlErrCode PlPowerMgrEraseMigrationData(PlPowerMgrMigrationDataId id) {
  ...
  pl_ret = PlPowerMgrEraseMigrationDataOsImpl(id);
