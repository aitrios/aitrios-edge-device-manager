...
|kEsfParameterStorageManagerItemMigrationDone
|Indicates whether firmware migration has been performed.
|kEsfParameterStorageManagerItemDNSSecondary
|Specifies the secondary DNS setting.
|kEsfParameterStorageManagerItemNTPServerSecondary
|Specifies the URL of the secondary NTP server.
|kEsfParameterStorageManagerItemCustom
...
|/camera_data_encr/NTPServerSecondary
|Read/Write
|×
|Reset
|×
...
|v0.3.4
a|Added support for migration information output.
...
|v0.3.5
a|Added support for secondary DNS and NTP.
