...
|To maintain compatibility with previous versions, this function migrates configuration data from the old format to the new format.
|<<#_Function11>>
|===
...
Function Details::
Determines whether data migration is required. +
For details, refer to <<#_PlNetworkIsNeedMigration, PlNetworkIsNeedMigration>>. +
+
Performs initialization processing for data migration. +
For details, refer to <<#_PlNetworkInitMigration, PlNetworkInitMigration>>. +
+
Retrieves configuration data in the old format. +
For details, refer to <<#_PlNetworkGetMigrationData, PlNetworkGetMigrationData>>. +
+
Performs finalization processing for data migration. +
For details, refer to <<#_PlNetworkFinMigration, PlNetworkFinMigration>>. +
+
Deletes configuration data in the old format. +
For details, refer to <<#_PlNetworkEraseMigrationSrcData, PlNetworkEraseMigrationSrcData>>.
...
|Structure representing information used to determine whether data migration is required.
|<<#_PlNetworkMigrationNeedParam>>

|PlNetworkMigrationHandle
|Handle used to retrieve configuration data in the old format.
|<<#_PlNetworkMigrationHandle>>

|enum PlNetworkMigrationDataId
|Enumeration representing the types of configuration data in the old format.
...
.Description of PlNetworkMigrationNeedParam values
[width="100%", cols="30%,70%",options="header"]
|===
|Member Name |Description
|int32_t netif_kind
|Type of network interface (0: Wi-Fi, 1: Ethernet)
|===
...
Information used to determine whether data migration is required.

**[OUT] bool *need_migration**:: 
A flag indicating whether data migration is required. true: migration required, false: migration not required.

* *Return Value* +
Returns one of the PlErrCode values according to the execution result.

* *Description* +
** This API can be used after PlNetworkInitialize has been executed.  
** For models other than T4R, returns need_migration = false.  
** For T4R, determines the necessity of data migration by referring to *param*, and returns the result to *need_migration*.
...
Pointer to the handle used to retrieve configuration data in the old format.
...
* *Description* +
** This API can be used after PlNetworkInitialize has been executed.  
** Not supported for models other than T4R.  
** For T4R, obtains a handle used to retrieve configuration data in the old format.
...
Type of configuration data in the old format.
...
* *Description* +
** This API can be used after PlNetworkInitMigration has been executed.  
** Not supported for models other than T4R.  
** For T4R, retrieves configuration data in the old format.
...
** This API can be used after PlNetworkInitialize has been executed.  
** Not supported for models other than T4R.  
** For T4R, releases the handle used to retrieve configuration data in the old format.
...
* *Description* +
** This API can be used after PlNetworkInitialize has been executed.  
** Does nothing for models other than T4R.  
** For T4R, deletes configuration data in the old format.
...
|v0.0.5
|
* Added component function description.
** 3.5.11. Data Migration Function +
