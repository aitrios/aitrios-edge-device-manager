...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogInit_ReturnDescriptions>> based on the execution result.

[#_UtilityLogInit_ReturnDescriptions]
.UtilityLogInit Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogDeinit_ReturnDescriptions>> based on the execution result.

[#_UtilityLogDeinit_ReturnDescriptions]
.UtilityLogDeinit Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogWriteDLog_ReturnDescriptions>> based on the execution result.

[#_UtilityLogWriteDLog_ReturnDescriptions]
.UtilityLogWriteDLog Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogWriteVDLog_ReturnDescriptions>> based on the execution result.

[#_UtilityLogWriteVDLog_ReturnDescriptions]
.UtilityLogWriteVDLog Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogWriteELog_ReturnDescriptions>> based on the execution result.

[#_UtilityLogWriteELog_ReturnDescriptions]
.UtilityLogWriteELog Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogForcedOutputToUart_ReturnDescriptions>> based on the execution result.

[#_UtilityLogForcedOutputToUart_ReturnDescriptions]
.UtilityLogForcedOutputToUart Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogBulkDLog_ReturnDescriptions>> based on the execution result.

[#_UtilityLogBulkDLog_ReturnDescriptions]
.UtilityLogBulkDLog Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogWriteBulkDLogNonNotify_ReturnDescriptions>> based on the execution result.

[#_UtilityLogWriteBulkDLogNonNotify_ReturnDescriptions]
.UtilityLogWriteBulkDLogNonNotify Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogRegisterSetDlogLevelCallback_ReturnDescriptions>> based on the execution result.

[#_UtilityLogRegisterSetDlogLevelCallback_ReturnDescriptions]
.UtilityLogSetDlogLevelCallback Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
...
* *Return Value* +
+
Returns one of the values from <<#_UtilityLogUnregisterSetDLogLevelCallback_ReturnDescriptions>> based on the execution result.

[#_UtilityLogUnregisterSetDLogLevelCallback_ReturnDescriptions]
.UtilityLogUnregisterSetDLogLevelCallback Return Value Descriptions
[width="100%", cols="30%,70%",options="header"]
|===
|Return Value |Description
